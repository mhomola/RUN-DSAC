...
class TorchReplayBuffer(ReplayBuffer):
    ...
    def __init__(self, max_replay_buffer_size, env, env_info_sizes=None):
        ...
        # Storing the observations twice may not be efficient in terms of memory usage, but it significantly simplifies
        # the code as it eliminates the need to be concerned with termination conditions.
        ...
        # Convert all the elements into a 2D numpy array, as it simplifies the understanding of the data's shape for
