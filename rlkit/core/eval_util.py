...
def get_generic_path_information(paths, stat_prefix=''):
    ...
    avg_returns = get_average_returns(paths)
    statistics[stat_prefix + 'Average Returns'] = avg_returns
    ...
    return statistics, avg_returns


def get_average_returns(paths):
    # Function to get the average returns
    returns = [sum(path["rewards"]) for path in paths]
