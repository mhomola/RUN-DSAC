...
class OneDimensionnalNF(nn.Module):
    def __init__(self, in_d, hidden_layers, nb_steps=200, n_out=1, dev="cuda:0"):
...
class MonotonicNN(nn.Module):
    ...
    hidden_layers : A list of the number of neurons, to be used by a network that compresses the non-monotonic variables
                    and by the integrand net.
    ...
    '''
    The forward procedure takes as input x which is the variable for which the integration must be made, h are just 
    other conditionning variables.
    '''
